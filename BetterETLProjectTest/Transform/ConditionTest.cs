...
public class ConditionTest
{
    ...
    public void PerformFilter_ShouldReturnAnswerTable_WhenDtoIsNotNull(DataTable expected, ConditionDto dto)
    {
        // Arrange
        ...
        var condition = new Condition(mockCreator, mockCommand, mockAdaptor);
        ...
        // Act
        var actual = condition.PerformFilter(dto);

        // Assert
        mockCommand.CommandText.Should().Contain("WHERE");
    ...
    {
        var firstDto = new ConditionDto("FirstName = 'Ali'", "Students", new ConnectionSetting());
    ...
    [Fact]
    public void PerformFilter_ShouldThrowArgumentException_WhenDtoIsNull()
    {
        // Arrange
        var mockCreator = Substitute.For<ICreatorConnection>();
        var mockCommand = Substitute.For<IDbCommand>();
        ...
        // Act
        var action = () => condition.PerformFilter(dto);
        // Assert
